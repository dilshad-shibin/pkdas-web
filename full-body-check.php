...
<img src="images/health-checkup/5s.jpg">
</div>
<h3 class="in_comntitle">Full Body Check</h3>
<ul class="inr_bult">                                               
 <li>Hemogram</li>
 <li>Blood grouping</li>
 <li>HbSAg</li>
 <li>Complete Urine Analysis</li>
 <li>Diabetic profile ( HbA1C)</li>
 <li>Renal Profile</li>
 <li>Lipid Profile</li>
 ...
 <li>Chest X-Ray</li>
 <li>USG Abdomen</li>
 <li>PSA (Male)/Pap Smear (Female)</li>
 <li>Physician</li>
 <li>Cardiologist</li>
 <li>Ophthalmology</li>
 <li>Gynecology</li>
...
<div class="whp_sidebar sidebar_ful_body_check">
<h4>Packages  </h4>
