...
<section class="cosmetdetailpage in_bg">
<div class="container">
<div class="row row_reverse ">
<div class="col-lg-8 ">
<div class="cs_detailcont">
<div class="cs_detailcont_img">
<img src="images/gdpt/cosmetology/3.jpg">
</div>
<h3 class="in_comntitle">Hair Treatments </h3>
<ul class="inr_bult">                                               
<li>Hair Transplantation (Surgical)</li>
...
<div class="col-lg-4">
<div class="cosdetail_sidbar">
<h4>Categories  </h4>
<ul>
<li><a href="hair-replacement.php" class="">Hair Replacement </a></li>
<li><a href="skin-treatment.php" class=" ">Skin Treatments </a></li>
<li><a href="hair-treatment.php" class="active" >Hair Treatments  </a></li>
<li><a href="body-treatment.php" class="">Body Treatments  </a></li>
