...
<section class="promo home_slider">
    <div class="promo-slider">
        <div class="promo-slider__item hm_slide_item">
            <picture>
                <img src="images/slider/bg2.jpg" class="img--bg" alt="">
            </picture>
            <div class="container">
                <div class="row">
...
<section class="who-we-are">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="img-side">
                    <img src="images/pathiripala/slider5.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="hm_gdpt_item">
                    <div class="hm_gdpt_item_img">
                        <img src="images/pathiripala/services/ambulance.jpg" alt="">
                    </div>
                    <div class="hm_gdpt_item_title">
                        ...
                        <div class="col-md-6">
                            <div class="contact-box">
                                ...
                                <div class="adress-section">
                                    <p>PK Das Multi Specialty Clinic, <br> 1st floor,Pathiripala Trade center, <br> Pathiripala,Palakkad</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="contact-box second">
                                ...
                                <div class="adress-section">
                                    <p>Contact : 0491 2964500, 8943221777</p>
