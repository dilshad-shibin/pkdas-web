            ...
            <div class="modal-body">
                ...
                <div class="modal-right">
                    ...
                    <form>
                        ...
                        <button type="submit" class="btn btn-bordered theme-btn">Submit</button>
                    </form>
                </div>
            </div>
        </div>
...
<section class="promo home_slider">
    <div class="promo-slider">
        <div class="promo-slider__item hm_slide_item">
            <picture>
                <img src="images/slider/slide-02.jpg" class="img--bg" alt="">
            </picture>
            <div class="container">
                <div class="row">
                        ...
                        <div class="align-container">
                            <div class="align-container__item slider_content">
                                <div class="promo-slider__wrapper-1">
                                    <h5 class="">Visit Us Now / Make An Appointment!</h5>
                                </div>
                                <div class="promo-slider__wrapper-2">
                                    <h3 class="">Quality & Affordable Healthcare</h3>
                                </div>
                                <div class="promo-slider__wrapper-3">
                                    ...
                                    <a href="tel:04884282141" class="theme_btn">+91 488 4282141</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="clinic-form">
    <div class="image-layer" style="background-image:url(images/pathiripala/1.png)"></div>
    <div class="container">
        <div class="row">
            <form action="">
...
<!-- feature section -->
<section class="feature-clinic">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="clinic-box">
                    <div class="iconbox-icon purple-box">
            ...
            <div class="col-lg-4">
                <div class="clinic-box">
                    <div class="iconbox-icon green-box">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="content-side">
                    <h2>About Our Multi Speciality Clinic - Thiruvilwamala</h2>
                    <p>The Multi Speciality Clinic - Thiruvilwamala was established with the aim of bringing international quality healthcare to every individual, thereby improving the overall well-being of a community. Excellence in patient care is achieved through high-quality and cost-effective healthcare services that address daily healthcare needs of you and your loved ones.</p>
                    <p>As your health is our utmost priority, the leading multi-speciality clinic in Thiruvilwamala offers a full suite of medical solutions including consultations with specialists, effective diagnostics, health check-ups, and pharmacy under one roof.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="img-side">
                    <img src="images/thiruvilwamala/about.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="clinic-services">
    <div class="st-shape4">
        <img src="images/pathiripala/shape/section_shape.png" alt="shape1">
    </div>
    <div class="container">
        <h3>Our Services</h3>
        <div class="heading-subtitle">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="hm_gdpt_item">
                    <div class="hm_gdpt_item_img">
                        <img src="images/pathiripala/services/14.jpg" alt="">
                    </div>
                    <div class="hm_gdpt_item_title">
                        <h4>Mother & Child Health Services</h4>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="hm_gdpt_item">
                    <div class="hm_gdpt_item_img">
                        <img src="images/pathiripala/services/6.jpg" alt="">
                    </div>
                    <div class="hm_gdpt_item_title">
                        <h4>Immunisation Services</h4>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="hm_gdpt_item">
                    <div class="hm_gdpt_item_img">
                        <img src="images/pathiripala/services/11.jpg" alt="">
                    </div>
                    <div class="hm_gdpt_item_title">
                        <h4>Health Education & Counselling</h4>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="hm_gdpt_item">
                    <div class="hm_gdpt_item_img">
                        <img src="images/pathiripala/services/1.jpg" alt="">
                    </div>
                    <div class="hm_gdpt_item_title">
                            ...
                            <svg class="abmsvg" xmlns="http://www.w3.org/2000/svg" width="" height="" viewBox="0 0 25.301 25.302">
                                <g id="Group_277" data-name="Group 277" transform="translate(-803.123 -39.576)">
                                    ...
                                    <g id="Group_117" data-name="Group 117">
                                        <path id="Path_79" data-name="Path 79" d="M24.848,31.347l-1.215-3.585a.484.484,0,0,0-.459-.329H23.1V20.409a6.152,6.152,0,0,0-12.3,0v7.024h-.07a.484.484,0,0,0-.459.329L9.056,31.347a.484.484,0,0,0,.459.64H24.389a.484.484,0,0,0,.459-.64ZM11.769,20.409a5.183,5.183,0,1,1,10.366,0v7.024H11.769ZM10.191,31.018l.886-2.616h11.75l.886,2.616Z" transform="translate(-9.031 -14.257)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_120" data-name="Group 120" transform="translate(815.289 39.826)">
                                    <g id="Group_119" data-name="Group 119">
                                        <path id="Path_80" data-name="Path 80" d="M24.508,0a.484.484,0,0,0-.484.484V3.391a.484.484,0,1,0,.969,0V.484A.484.484,0,0,0,24.508,0Z" transform="translate(-24.023)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_122" data-name="Group 122" transform="translate(815.289 44.62)">
                                    <g id="Group_121" data-name="Group 121">
                                        <path id="Path_81" data-name="Path 81" d="M24.85,9.806a.485.485,0,1,0,.142.343A.487.487,0,0,0,24.85,9.806Z" transform="translate(-24.023 -9.664)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_124" data-name="Group 124" transform="translate(805.29 52.792)">
                                    <g id="Group_123" data-name="Group 123">
                                        <path id="Path_82" data-name="Path 82" d="M6.575,26.139H4.35a.484.484,0,0,0,0,.969H6.575a.484.484,0,1,0,0-.969Z" transform="translate(-3.866 -26.139)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_126" data-name="Group 126" transform="translate(803.373 52.792)">
                                    <g id="Group_125" data-name="Group 125">
                                        <path id="Path_83" data-name="Path 83" d="M.828,26.281a.484.484,0,0,0-.685,0,.484.484,0,0,0,.342.827.484.484,0,0,0,.342-.827Z" transform="translate(-0.001 -26.139)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_132" data-name="Group 132" transform="translate(823.265 52.792)">
                                    <g id="Group_131" data-name="Group 131">
                                        <path id="Path_86" data-name="Path 86" d="M42.812,26.139H40.588a.484.484,0,0,0,0,.969h2.224a.484.484,0,0,0,0-.969Z" transform="translate(-40.104 -26.139)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_134" data-name="Group 134" transform="translate(827.205 52.792)">
                                    <g id="Group_133" data-name="Group 133">
                                        <path id="Path_87" data-name="Path 87" d="M48.873,26.281a.484.484,0,1,0,.142.342A.488.488,0,0,0,48.873,26.281Z" transform="translate(-48.046 -26.139)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_136" data-name="Group 136" transform="translate(822.142 43.555)">
                                    <g id="Group_135" data-name="Group 135">
                                        <path id="Path_88" data-name="Path 88" d="M41.05,7.66a.485.485,0,0,0-.685,0l-2.383,2.384a.484.484,0,0,0,.685.685L41.05,8.345A.485.485,0,0,0,41.05,7.66Z" transform="translate(-37.839 -7.518)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                    <g id="Group_138" data-name="Group 138" transform="translate(806.052 43.555)">
                                    <g id="Group_137" data-name="Group 137">
                                        <path id="Path_89" data-name="Path 89" d="M8.613,10.043,6.229,7.66a.484.484,0,0,0-.685.685l2.384,2.383a.484.484,0,0,0,.685-.685Z" transform="translate(-5.402 -7.518)" fill="#fff" stroke="#fff" stroke-width="0.5"></path>
                                    </g>
                                    </g>
                                </g>
                            </svg>  
    ...
    <div class="container">
        ...
        <div class="row mt-100">
            <div class="col-lg-6">
                <div class="contact-form">
                    ...
                    <form method="post" class="contact-validation-active" id="contact-form" novalidate="novalidate">
                        ...
                        <div>
                            <textarea class="form-control" name="note" id="note" placeholder="Enter your Message.."></textarea>
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31354.970392703253!2d76.326977!3d10.782848!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8c723734a47875b4!2sPK%20DAS%20Institute%20of%20Medical%20Sciences%20-%20Hospital%20and%20Medical%20College!5e0!3m2!1sen!2sin!4v1602675560911!5m2!1sen!2sin" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
            <div class="col-md-12">
                <div class="contact-form">
                        ...
                        <div class="col-md-6">
                            <div class="contact-box">
                                ...
                                <div class="adress-section">
                                    <p>PK Das Multi Specialty Clinic, <br> Near Bus stand, <br> Thiruvilwamala,Thrissur</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="contact-box second">
                                ...
                                <div class="adress-section">
                                    <p>Contact : 04884 282141 ,0488 4282141</p>
                                    <p>Office : 9847052455 </p>
                                </div>
                            </div>
                        </div>
                    </div>
