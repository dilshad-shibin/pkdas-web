...
<div class="body_wraper overflowset">
<?php include 'header.php'?>  
 
  
<section>
<div class="health_chex_detail in_bg ">
<div class="health_chex_row">
<div class="container">
<div class="row">
<div class="col-lg-8 wow fadeInUp " data-wow-duration="1s" data-wow-delay=".2s">
<div class="hc_detail_right">
<div class="hcdetail_img">
<img src="images/health-checkup/4s.jpg">
</div>
<h3 class="in_comntitle">Well Women Check Up</h3>
<ul class="inr_bult">                                               
 <li>Hemogram</li>
 ...
 <li>USG Abdomen</li>
 <li>PAP Smear</li>
 <li>Mammogram (Optional)</li>
 <li>Consultations Gynecologist</li>
 <li>1 Specialist (Optional)</li>
</ul>
</div>
</div>
<div class="col-lg-4 wow fadeInUp">
<div class="whp_sidebar sidebar_well_women_check">
<h4>Packages  </h4>
<?php include 'health-check-sidebar.php'?>  
</div>
</div>
</div> 
</div>
